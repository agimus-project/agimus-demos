...
> [!CAUTION]
> This demo is **CPU intensive** and strongly rely on short computation time. Even as simple motion as sinusid can become unstable if the optimal control problem does not have time to converge! Make sure you **run this demo on a modest computer** or it may cause **injuries** or **even death**!
