...
Robot.urdfFilename = "package://example-robot-data/robots/tiago_pro_description/robots/tiago_pro.urdf"
Robot.srdfFilename = ""
...
lockedJoints = list(filter(lambda j: not j.startswith('tiago/arm_left'), robot.jointNames))
...
ps.client.basic.problem.createTransformationR3xSO3Constraint(
    "ee-pose", "", "tiago/arm_left_6_joint",
    [0.5196730441033661, 0.034650161767261184, 0.9812741725898027, -0.6206963609757624, 0.674163364588632, -0.13794947533411075, -0.3757788279999625],
...
p1 = wd(spline.createSplinePath(rhs0, rhs1, 1., [1], derivative, [1], derivative))
p2 = wd(spline.createSplinePath(rhs1, rhs2, 1., [1], derivative, [1], derivative))
p3 = wd(spline.createSplinePath(rhs2, rhs3, 1., [1], derivative, [1], derivative))
p4 = wd(spline.createSplinePath(rhs3, rhs0, 1., [1], derivative, [1], derivative))
p = p1.asVector()
p.appendPath(p2)
p.appendPath(p3)
p.appendPath(p4)
