...
def main(args=None) -> int:
    ...
    if "metal" in args:
        # Order of values is: (force weights, handle name, whether or not reife the pose)
        weighted_handles = [
        ...
        weighted_handles = [
            ...
            ([0.000002, 0.000002, 0.000002], "hole_back_right_2", True),
            ([0.000009, 0.000009, 0.000009], "hole_left_inside_33", False),
